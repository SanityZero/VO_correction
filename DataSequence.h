...
public:
    ...
    void load_model(DataSeq_model_Type, string);
    void loadBINS(string, string);
    bool calculate_next_point(string);
...
bool Data_seq::calculate_next_point(string integr_method = "E") {
    //static Point3d vel;
    static Mat C0;
    static Mat C;
...
void Data_seq::load_model(DataSeq_model_Type model, string angle_type = "EC") {
    this->angle_type = angle_type;
